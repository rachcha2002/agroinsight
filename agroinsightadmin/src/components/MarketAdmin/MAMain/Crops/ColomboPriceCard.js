...
function ColomboPriceCard() {
  ...
  const update = (id) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_BACKEND_URL}/crop/updateprice/${id}`,
        CropToUpdate
      )
      .then((response) => {
        console.log(response);
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Today Price List - Colombo", 14, 40);
            ...
            <div className="product-card">
              ...
              <div className="product-name">
                ...
                <input
                  ...
                  type="number"
                  value={Crop.Price}
                  onChange={(e) => handlePriceChange(Crop._id, e.target.value)}
                  style={{
                    border: "none",
                    outline: "none",
                    width: "50%",
